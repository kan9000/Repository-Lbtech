...
<head>
  ...
  <title>คลังปัญญา- @yield('title')</title>
  <!-- shortcut icon -->
  <link rel="icon" href="{{ asset('favicon.jpg') }}" type="image/x-icon">
  <link rel="shortcut icon" href="{{ asset('favicon.jpg') }}" type="image/x-icon">

  <!-- App css -->
  <link href="{{ asset('template/Admin/horizontal/dist/assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" id="bootstrap-stylesheet" />
  <link href="{{ asset('template/Admin/horizontal/dist/assets/css/icons.css') }}" rel="stylesheet" type="text/css" />
  <link href="{{ asset('template/Admin/horizontal/dist/assets/css/app.css') }}" rel="stylesheet" type="text/css" id="app-stylesheet" />
  <link href="{{ asset('template/Admin/horizontal/dist/assets/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
...
<body> 
  ...
  <script src="{{ asset('template/Admin/horizontal/dist/assets/js/vendor.min.js') }}"></script>
  <script src="{{ asset('template/Admin/horizontal/dist/assets/js/app.min.js') }}"></script>
  @stack('scripts')
